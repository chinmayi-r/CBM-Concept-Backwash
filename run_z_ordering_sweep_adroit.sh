...
#SBATCH --job-name=fb_sweep_orig
#SBATCH --output=logs/fb_sweep_orig_%j.out

# Z-ordering sweep for ORIGINAL species-level MCBM checkpoints.
# Requires: checkpoints_funnybirds/mcbm_fb_gamma{0.0,0.1,0.5,1.0,5.0}.pth
# Outputs:  fb_mcbm_z_ordering_gamma{G}_v2.csv  (one per gamma)
