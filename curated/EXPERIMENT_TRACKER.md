...
| 5 | CUB/CUB70: does the mechanism transfer to real birds? | CUB70-CBM exploration executed; reciprocal whole-part deletion ran; small-patch v1 and corrected matched-control v2 FunnyBird calibrations ran | **OBSERVATIONAL CANDIDATE; CAUSAL TESTS QUARANTINED**. Whole-part edits were invalid; v1 omitted wing; v2 recovered 34,107 rows but still failed its raw-`z` gate and correctly stopped before CUB70 | Inspect the v2 audit, table, plots, and every intervention sheet before deciding whether the method or the proposed cross-part prediction failed | After CBM story |
