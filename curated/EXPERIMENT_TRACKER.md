...
| 5 | CUB/CUB70: does the mechanism transfer to real birds? | CUB70-CBM exploration executed; mask omissions/collapse audited; reciprocal whole-part deletion ran on seed 1 | **OBSERVATIONAL CANDIDATE; CAUSAL DELETION QUARANTINED** because FunnyBird calibration failed and edits were visibly invalid | Randomized small-patch dose response is implemented and pending; FunnyBird must pass before CUB70 runs | After CBM story |
