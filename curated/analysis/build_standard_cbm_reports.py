...
PLAIN_CAPTIONS = {
    ...
    "fb-r2": "The renderer changes the named part while preserving the rest of the bird and scene, which makes the immediate within-image response causally interpretable.",
